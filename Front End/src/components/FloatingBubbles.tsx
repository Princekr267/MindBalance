...
import bubbleImg from "figma:asset/18680a3167c361ca279402a28253228f3e6779f2.png";
...
interface BubbleProps {
  ...
  allBubbles: { x: number; y: number; size: number; id: number }[];
  scrollHeight: number;
}

function Bubble({ id, initialX, initialY, size, onPop, allBubbles, scrollHeight }: BubbleProps) {
